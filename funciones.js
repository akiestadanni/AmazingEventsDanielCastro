export const contenedorSearch = document.getElementById("search");

export function filtrarEventosChecked(eventos) {
...
export function filtrarTextoIngresado(eventos) {
